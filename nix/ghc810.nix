# To use this package set in your `haskell-flake` projects:
#
# > haskellProjects.ghc810.imports = [ ./this-file.nix ];
#
# And use it in the `basePackages` option of *your* actual project:
# 
...
in
{
  # A generic package set has no local packages.
  packages = { };
